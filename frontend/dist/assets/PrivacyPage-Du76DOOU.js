import{a as s,j as e}from"./index-kF6qpn0X.js";const c="May 1, 2026",o="Orbis Technologies, Inc.",t="privacy@orbis.app",d=[{id:"overview",title:"1. Overview",content:`${o} ("Orbis," "we," "us," or "our") operates the Orbis platform, accessible at orbis.app (the "Service"). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use the Service.

We are committed to protecting your privacy. If you do not agree with the terms of this Privacy Policy, please do not use the Service. We may update this policy from time to time; continued use of the Service constitutes your acceptance of the updated policy.`},{id:"information-collected",title:"2. Information We Collect",content:`We collect the following categories of information:
...
Communications. If you contact us via email or a support channel, we retain a copy of your message and our response.`},{id:"how-used",title:"3. How We Use Your Information",content:`We use the information we collect to:
...
Communicate with you about product updates, new features, promotions, and important notices. You may opt out of non-transactional emails at any time by clicking "Unsubscribe" or contacting us at ${t}.
...
Comply with legal obligations, including responding to lawful requests from courts and regulatory authorities.`},{id:"third-parties",title:"4. Third-Party Services",content:`We rely on the following third-party service providers, each of whom may process your data as described:
...
We do not sell your personal information to data brokers or advertising networks.`},{id:"sharing",title:"5. How We Share Your Information",content:`We do not sell, rent, or trade your personal information. We share data only in the following limited circumstances:
...
With Your Consent. We may share your information for any other purpose with your explicit consent.`},{id:"retention",title:"6. Data Retention",content:`We retain your account information for as long as your account is active and for a reasonable period afterward to comply with legal obligations, resolve disputes, and enforce agreements.
...
You may request deletion of your account and associated data at any time by contacting ${t}.`},{id:"rights",title:"7. Your Rights and Choices",content:`Depending on your location, you may have certain rights regarding your personal information:
...
To exercise any of these rights, contact us at ${t}. We will respond within 30 days. We may need to verify your identity before processing your request.`},{id:"cookies",title:"8. Cookies and Tracking",content:`We use cookies and similar technologies to operate the Service. Specifically:
...
You can configure your browser to refuse cookies, but doing so may impair certain features of the Service.`},{id:"security",title:"9. Security",content:`We implement industry-standard security measures to protect your information, including:
...
In the event of a data breach that affects your personal information, we will notify you as required by applicable law.`},{id:"children",title:"10. Children's Privacy",content:`The Service is not directed to, and we do not knowingly collect personal information from, persons under the age of 13. If you are between the ages of 13 and 18, you may only use the Service with the consent of a parent or legal guardian.

If we become aware that we have collected personal information from a child under 13 without parental consent, we will take steps to delete that information promptly. If you believe we may have collected information from a minor, please contact us at ${t}.`},{id:"international",title:"11. International Data Transfers",content:`Orbis is based in the United States. If you access the Service from outside the United States, your information may be transferred to and processed in the United States, where data protection laws may differ from those in your country.

By using the Service, you consent to the transfer of your information to the United States. We take reasonable steps to ensure that your data is treated securely and in accordance with this Privacy Policy.`},{id:"changes",title:"12. Changes to This Privacy Policy",content:`We may update this Privacy Policy from time to time. When we do, we will update the "Last Updated" date at the top of this page. For material changes, we will send a notice to the email address associated with your account at least 14 days before the change takes effect.

We encourage you to review this Privacy Policy periodically.`},{id:"contact",title:"13. Contact Us",content:`If you have questions, concerns, or requests regarding this Privacy Policy or the handling of your personal data, please contact our privacy team at:

${o}
Email: ${t}

We aim to respond to all privacy inquiries within 5 business days.`}];function u(){const r=s();return e.jsxs("div",{className:"min-h-screen bg-black text-white",children:[e.jsx("div",{className:"fixed inset-0 pointer-events-none",children:e.jsx("div",{className:"absolute inset-0 opacity-[0.04]",style:{backgroundImage:"linear-gradient(to right, #00ff88 1px, transparent 1px), linear-gradient(to bottom, #00ff88 1px, transparent 1px)",backgroundSize:"80px 80px"}})}),e.jsxs("div",{className:"relative mx-auto max-w-4xl px-4 sm:px-6 py-24",children:[e.jsx("button",{onClick:()=>r("/"),className:"mb-12 font-mono text-xs uppercase tracking-wider text-white/40 hover:text-[#00ff88] transition-colors",children:"← Back to Home"}),e.jsxs("div",{className:"mb-16",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-4",children:[e.jsx("div",{className:"h-px w-8 bg-[#00ff88]"}),e.jsx("span",{className:"font-mono text-xs uppercase tracking-wider text-[#00ff88]",children:"Legal"}),e.jsx("div",{className:"h-px w-8 bg-[#00ff88]"})]}),e.jsx("h1",{className:"text-4xl sm:text-5xl font-bold mb-4",children:"Privacy Policy"}),e.jsxs("p",{className:"font-mono text-sm text-white/40",children:["Last Updated: ",c]}),e.jsx("div",{className:"mt-6 border-l-2 border-[#00ff88]/40 pl-4",children:e.jsx("p",{className:"font-mono text-sm text-white/60 leading-relaxed",children:"This Privacy Policy describes how Orbis collects, uses, and protects your personal information. We believe in transparency — if anything is unclear, please contact us."})})]}),e.jsx("div",{className:"space-y-12",children:d.map(a=>e.jsxs("div",{id:a.id,className:"border-b border-[#1a1a1a] pb-12",children:[e.jsx("h2",{className:"font-mono text-lg font-bold text-white mb-4",children:a.title}),e.jsx("div",{className:"space-y-4",children:a.content.split(`

`).map((i,n)=>e.jsx("p",{className:"font-mono text-sm leading-relaxed text-white/70",children:i},n))})]},a.id))}),e.jsx("div",{className:"mt-16 border border-[#00ff88]/20 bg-[#00ff88]/5 p-6",children:e.jsxs("p",{className:"font-mono text-xs text-white/60 text-center",children:["Privacy questions? Contact us at"," ",e.jsx("a",{href:`mailto:${t}`,className:"text-[#00ff88] hover:underline",children:t})]})})]})]})}export{u as default};
