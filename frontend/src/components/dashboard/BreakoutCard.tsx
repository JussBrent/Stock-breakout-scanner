...
import { ChevronDown, ChevronUp, TrendingUp, ShoppingCart } from 'lucide-react'
import { StockChart } from './StockChart'
import { UnifiedTradeModal } from './UnifiedTradeModal'
    ...
    <>
            ...
            <div className="flex flex-col items-end gap-2">
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-bold bg-blue-500/20 text-blue-400 hover:bg-blue-500/30 transition-colors border border-blue-500/30"
                >
      ...
      {tradeModalOpen && (
        <UnifiedTradeModal
          ...
          suggestedEntry={scan.trigger_price}
          setupType={scan.setup_type}
