    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="min-h-screen ml-[var(--sidebar-w,60px)] transition-[margin-left] duration-300 ease-in-out">
        <header className="fixed top-0 left-[var(--sidebar-w,60px)] transition-[left] duration-300 ease-in-out right-0 z-40 h-12 border-b border-white/8 bg-[#0d0d0d] flex items-center px-6 gap-3">
          <Wallet className="h-4 w-4 text-white/40 shrink-0" />
          <span className="text-sm font-semibold text-white tracking-tight">Portfolio</span>
          <span className="text-white/20 text-sm">/</span>
          <span className="text-xs text-white/40 font-mono">Brokerage · Buying Power · Holdings</span>
        </header>

        <main className="pt-12 p-8 space-y-6">
          {error && (
